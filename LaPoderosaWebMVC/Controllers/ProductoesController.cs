...
namespace LaPoderosaWebMVC.Controllers
{
    public class ProductoesController : Controller
    {
        ...
        {
            var productos = db.Productos.Include(p => p.Proveedor).Include(p => p.Categoria);
        ...
        public ActionResult Create([Bind(Include = "Id,NombreProducto,CantidadPorUnidad,PrecioUnidad,UnidadEnExistencia,img,ProveedorId,CategoriaId")] Producto producto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,NombreProducto,CantidadPorUnidad,PrecioUnidad,UnidadEnExistencia,img,ProveedorId,CategoriaId")] Producto producto)
        {
            if (ModelState.IsValid)
            {
